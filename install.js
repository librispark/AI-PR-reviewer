...
const scriptFile3Src = path.join(__dirname, 'openai_helper.py');
...
const scriptFile3Dest = path.join(process.cwd(), '.github', 'scripts', 'openai_helper.py');
...
copyFile(scriptFile3Src, scriptFile3Dest);
